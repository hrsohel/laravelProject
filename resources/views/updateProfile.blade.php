        ...
        <div style="margin-left: auto !important;" class="col-md-6 form-container">
            ...
            <h3 class="text-center">Update Profile</h3>    
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" value="{{$user['name']}}" class="form-control" id="inputEmail1" required>
                </div>
                <div class="col-md-6">
                    <label for="inputEmail2" class="form-label">Phone Number</label>
                    <span class="ml-auto" style="color: red"> * Required Feild</span>
                    <input type="number" value="0{{$user['phone']}}" name="phone" class="form-control" id="inputEmail2" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" value="{{$user['email']}}" name="email" class="form-control" id="inputEmail3" >
                </div>
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Date Of Birth (mm/dd/yyyy)</label>
                    <span style="color: red"> * Required Feild</span>
                    <input type="date" value="{{$user['dob']}}" name="dob" class="form-control" id="inputEmail4" required>
                </div>
                <div class="col-md-6">
                    <label for="inputEmail6" class="form-label">Address</label>
                    <span style="color: red"> * Required Feild</span>
                    <textarea name="address" id="inputEmail6" class="form-control" required>{{$user['address']}}</textarea>
                </div>
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Blood Group</label>
                    <span style="color: red"> * Required Feild</span>
                    <select name="bloodGroup" value="{{$user['bloodGroup']}}" class="form-select" id="" required>
                        <option>Select Blood Group</option>
                        <option value="A+" @selected($user->bloodGroup === "A+")>A+</option>
                        <option value="A-" @selected($user->bloodGroup === "A-")>A-</option>
                        <option value="B+" @selected($user->bloodGroup === "B+")>B+</option>
                        <option value="B-" @selected($user->bloodGroup === "B-")>B-</option>
                        <option value="AB+" @selected($user->bloodGroup === "AB+")>AB+</option>
                        <option value="AB-" @selected($user->bloodGroup === "AB-")>AB-</option>
                        <option value="O+" @selected($user->bloodGroup === "O+")>O+</option>
                        <option value="O-" @selected($user->bloodGroup === "O-")>O-</option>
                    </select>
                </div>
                <div class="col-md-6">
                    ...
                    <span style="color: red"> * Required Feild</span>
                    <input type="date" value="{{$user['lastDonated']}}" name="lastDonated" class="form-control" id="inputEmail6" required>
                </div>
                <!-- <div class="col-md-6">
